...
public class NaverMapsPlugin
  ...
  private static final String VIEW_TYPE = "plugins.barogo.com/naver_maps";
  ...
  public static void registerWith(Registrar registrar) {
    ...
    final NaverMapsPlugin plugin = new NaverMapsPlugin(registrar.activity());
  ...
  private NaverMapsPlugin(Activity activity) {
